...
> Notice: If you are getting a Heroku policy error please refer to this [discussion](https://github.com/bryzr/ghost-v4-on-heroku/discussions/24).
...
If the above button does not work for you, disable anything that might be blocking Heroku from inferring the referrer (e.g. Brave shield), or try this: https://heroku.com/deploy?template=https://github.com/bryzr/ghost-v4-on-heroku (if you're using a fork, make sure to point the template link to your repo).
...
- [Open an Issue](https://github.com/bryzr/ghost-v4-on-heroku/issues/new/)
- [Use GitHub Discussions](https://github.com/bryzr/ghost-v4-on-heroku/discussions)

### License
Released under the [MIT license](https://github.com/bryzr/ghost-v4-on-heroku/blob/main/LICENSE), just like the Ghost project itself.
